...
var dialogues: Array[String] = [
	"Ainda bem que você apareceu, jovem guerreiro! O destino nos uniu neste momento sombrio...",
	"O nosso reino está em pedaços. Uma guerra devastadora começou, e os portões da capital foram violados.",
	"Para piorar, o nosso Rei foi raptado pelas forças inimigas no meio do caos!",
	"Sua grande aventura começa agora. O caminho será perigoso, mas precisamos da sua lâmina.",
	"Lute pelo reino, salve o Rei e sua bravura será recompensada além dos seus sonhos. Vá!"
]
